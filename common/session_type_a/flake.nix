      ...
      nixosModules.default =
        ...
        }:
        {
          ...
          services.displayManager.sessionPackages = [
            (pkgs.writeTextFile {
              name = "session_type_a.desktop";
              destination = "/share/wayland-sessions/session_type_a.desktop";
              text = ''
                [Desktop Entry]
                Name=Session Type A
                Comment=Session Type A with Dank Material Shell and Hyprland
                Exec=Hyprland --config /etc/hypr/hyprland_session_type_a.conf
                Type=Application
